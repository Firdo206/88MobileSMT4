...
class OrderCard extends StatelessWidget {
  ...
  /// ================= HARGA AKTIF (prioritas final_price) =================
  dynamic get displayPrice {
    final finalPrice = data["final_price"];
    if (finalPrice != null) {
      final parsed = double.tryParse(finalPrice.toString());
      if (parsed != null && parsed > 0) return finalPrice;
    }
  ...
  bool get hasDiscount {
    ...
    if (finalPrice == null || totalPrice == null) return false;
    final fp = double.tryParse(finalPrice.toString()) ?? 0;
    final tp = double.tryParse(totalPrice.toString()) ?? 0;
    return fp > 0 && fp < tp;
  }
